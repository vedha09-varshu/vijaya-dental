    ...
    <section id="contact" className="section-padding bg-soft-gradient">
      <div className="container mx-auto">
        ...
        <div className="text-center max-w-2xl mx-auto mb-14">
          <div className="text-secondary font-semibold mb-3 tracking-wide uppercase text-sm">
            Get In Touch
          </div>
          ...
          <div className="bg-card-gradient text-primary-foreground rounded-3xl p-8 md:p-10 shadow-elegant relative overflow-hidden">
            ...
            <div className="space-y-6 relative">
              ...
              <ContactItem icon={Phone} title="Call Us">
                <a href="tel:9059198393" className="hover:text-accent transition-smooth">
                  90591 98393
                </a>
              </ContactItem>
              ...
              <ContactItem icon={Mail} title="Email Us">
                <a
                  href="mailto:vdcmuralinagar@gmail.com"
                  className="hover:text-accent transition-smooth break-all"
                >
          ...
          <div className="bg-background rounded-3xl p-8 md:p-10 shadow-soft border border-border/50">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <Textarea
                  name="message"
                  placeholder="Preferred date/time or concern..."
